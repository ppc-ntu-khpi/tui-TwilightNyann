...
import com.mybank.tui.Bank;
import com.mybank.tui.Customer;
import com.mybank.tui.Account;
            ...
            public void DO() {
                try {
                    ...
                    if (customer != null) {
                        ...
                        detailText.append("Owner Name: ").append(customer.getName()).append(" (id=").append(custNum).append(")\n");
